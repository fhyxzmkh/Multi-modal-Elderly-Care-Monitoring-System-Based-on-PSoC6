...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Other Functions
        mNavDrawerItems.add(new NavigationDrawerModel(
                mNavMenuTitles[ItemPosition.OTHER_FUNCTIONS],
                mNavMenuIcons.getResourceId(ItemPosition.OTHER_FUNCTIONS, -1)));
